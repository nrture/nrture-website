...
export function TalkToUsPage() {
  return (
    <div className="min-h-screen bg-white text-ink">
      ...
      <main className="mx-auto mt-[24vh] sm:mt-[22vh] md:mt-[20vh] lg:mt-[18vh] xl:mt-[18vh] 2xl:mt-[22vh] flex w-full max-w-6xl flex-col gap-10 px-6 pb-16 lg:flex-row lg:items-start lg:gap-12">
